...
class Scraper(object):
    ...
    def __init__(self, cookie=None, driver=selenium.webdriver.Chrome, driver_options=HEADLESS_OPTIONS, scroll_pause=0.1, scroll_increment=300, timeout=10):
        ...
        self.driver = driver(environ['CHROME_DRIVER'], **driver_options)
